...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ Aguarde, estamos processando ⌛',
				success: '✔️ Sucesso ✔️',
				error: {
					stick: '❌ Falhou!, ocorreu um erro ao converter a imagem em um Sticker ❌',
					Iv: '❌ Link inválido ❌'
				},
				only: {
			...
			const ownerNumber = ["11952968233@s.whatsapp.net"] // replace this with your number
